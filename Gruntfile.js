...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      injectJS: {
        files: [
          '<%= yeoman.client %>/{app,components,assets}/**/!(*.spec|*.mock).js',
      ...
      livereload: {
        files: [
          '{.tmp,<%= yeoman.client %>}/{app,components,assets}/**/*.{css,html}',
          '{.tmp,<%= yeoman.client %>}/{app,components,assets}/**/!(*.spec|*.mock).js',
